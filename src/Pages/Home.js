    ...
    <>
      ...
      <div className="py-16">
        <div className="container mx-auto">
          <Link
            to={"/create"}
            className={`p-4 rounded-full bg-[#f57c00] text-white `}
          >
            Create Note
          </Link>
          {!loading && Notes.length === 0 && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-w-sm mx-auto md:mx-0 md:max-w-none py-16">
            {Notes.map((data, index) => (
              <div
                key={index}
                className="border-solid border-2 border-gray-300 rounded-lg max-w-[300px] p-4 flex flex-col gap-4 transform transition-transform hover:scale-105 hover:shadow-lg"
              ...
              >
                ...
                <div>
                  <div className="rounded-lg p-4 bg-gradient-to-r from-purple-500 via-blue-500 to-green-500 text-white">
                    <h1 className="font-semibold text-xl">Description :</h1>
                    <span
                      className="line-clamp-2"
                      dangerouslySetInnerHTML={{ __html: data.description }}
                  ...
                  <div className="modal-box">
                    ...
                    <div className="modal-action">
                      <form method="dialog">
                        <button
                          onClick={() => deletenotes(id)}
                          className="bg-violet-500 text-white py-3 px-4 mr-4 rounded-full hover:opacity-90"
                        >
                          Delete
                        </button>
                        <button className="btn">Close</button>
